...
namespace EMS.Persistence.Migrations
{
    ...
    [Migration("20260730190424_AddOfficeGeofencingAndMileageReimbursement")]
    partial class AddOfficeGeofencingAndMileageReimbursement
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EMS.Domain.Entities.MessageParticipant", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("MessageParticipants", (string)null);
                });
            ...
            modelBuilder.Entity("EMS.Domain.Entities.Message", b =>
                {
                    b.HasOne("EMS.Domain.Entities.Conversation", null)
                        .WithMany()
