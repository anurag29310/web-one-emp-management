    ...
    public class RoleConfiguration : IEntityTypeConfiguration<Role>
    {
        public void Configure(EntityTypeBuilder<Role> builder)
        {
            ...
            builder.HasData(
                ...
                // Sits above every tenant — the only role whose Users have a null CompanyId. Manages
                // Companies via the separate /api/v1/platform surface, not day-to-day tenant data.
                new Role { Id = new Guid("55555555-5555-5555-5555-555555555555"), Name = "SuperAdmin", IsDeleted = false, CreatedAtUtc = new DateTime(2026, 1, 1, 0, 0, 0, DateTimeKind.Utc) }
            );
        }
    }
}
