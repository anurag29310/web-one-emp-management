...
namespace EMS.Application.Features.Employees.Handlers
{
    public class UpdateEmployeeStatusCommandHandler : IRequestHandler<UpdateEmployeeStatusCommand>
    {
        ...
        public UpdateEmployeeStatusCommandHandler(IEmployeeRepository repo, IAuditLogger auditLogger, ICurrentUserService currentUser, ILogger<UpdateEmployeeStatusCommandHandler> logger)
        {
            _repo = repo;
