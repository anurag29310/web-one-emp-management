...
{
    public class UploadReimbursementAttachmentCommandValidator : AbstractValidator<UploadReimbursementAttachmentCommand>
    {
        public const long MaxFileSizeBytes = 10 * 1024 * 1024; // 10 MB

        // requirements.md lists PDF, JPG, PNG, JPEG explicitly for reimbursement attachments.
        ...
        public UploadReimbursementAttachmentCommandValidator()
        {
        ...
        // Mirrors UploadDocumentCommandValidator / Tasks' UploadTaskAttachmentCommandValidator.
